    ...
    <div className={`landing-wrapper ${theme}-theme`}>
      ...
      <main style={{ maxWidth: "800px", margin: "60px auto 100px", padding: "0 24px", position: "relative", zIndex: 5 }}>
        ...
        <p style={{ color: "var(--text-sub)", fontSize: "1.05rem", lineHeight: "1.6", marginBottom: "32px" }}>
          CustomerIQ respects your privacy and is committed to protecting any information provided through our services.
        </p>

        <div style={{ display: "flex", flexDirection: "column", gap: "32px", color: "var(--text-main)" }}>
          <section>
            <h2 style={{ fontSize: "1.3rem", fontWeight: "700", marginBottom: "12px" }}>Information We Collect</h2>
            <ul style={{ color: "var(--text-sub)", lineHeight: "1.8", fontSize: "0.95rem", paddingLeft: "20px" }}>
              <li>Customer demographic information</li>
              <li>Customer purchase and transaction data</li>
              <li>Information submitted through prediction forms</li>
            </ul>
          </section>

          <section>
            <h2 style={{ fontSize: "1.3rem", fontWeight: "700", marginBottom: "12px" }}>How We Use Information</h2>
            <ul style={{ color: "var(--text-sub)", lineHeight: "1.8", fontSize: "0.95rem", paddingLeft: "20px" }}>
              <li>Generate customer segmentation predictions</li>
              <li>Provide analytics and business insights</li>
              <li>Improve platform performance and user experience</li>
            </ul>
          </section>

          <section>
            <h2 style={{ fontSize: "1.3rem", fontWeight: "700", marginBottom: "12px" }}>Data Security</h2>
            <p style={{ color: "var(--text-sub)", lineHeight: "1.6", fontSize: "0.95rem" }}>
              We implement reasonable security measures to protect submitted information from unauthorized access.
            </p>
          </section>

          <section>
            <h2 style={{ fontSize: "1.3rem", fontWeight: "700", marginBottom: "12px" }}>Third-Party Services</h2>
            <p style={{ color: "var(--text-sub)", lineHeight: "1.6", fontSize: "0.95rem" }}>
              CustomerIQ may use third-party technologies and open-source libraries to deliver its services.
            </p>
          </section>

          <section>
            <h2 style={{ fontSize: "1.3rem", fontWeight: "700", marginBottom: "12px" }}>Educational Project Notice</h2>
            <p style={{ color: "var(--text-sub)", lineHeight: "1.6", fontSize: "0.95rem" }}>
              CustomerIQ is developed as an educational and demonstration project. Users should not submit sensitive personal information.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ color: "var(--text-sub)", lineHeight: "1.6", fontSize: "0.95rem" }}>
              For questions regarding this policy, please contact the project team.
            </p>
          </section>
        </div>
      </main>
